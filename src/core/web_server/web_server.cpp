...
void WebServer::RunImpl(WebServerConfig config) {
  ...
  auto json_cb = [](std::function<void(const HttpResponsePtr&)>&& callback, const std::string& body,
  ...
  auto plain_cb = [](std::function<void(const HttpResponsePtr&)>&& callback, const std::string& body,
  ...
  auto serve_tile = [&plain_cb](const std::string& tiles_dir, const std::string& z, const std::string& x,
