...
static const _MapProperty_type_support_symbol_names_t _MapProperty_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, topology_msgs, msg, MapProperty)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, topology_msgs, msg, MapProperty)),
  }
};
...
{
  return &::topology_msgs::msg::rosidl_typesupport_cpp::MapProperty_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, topology_msgs, msg, MapProperty)() {
  return get_message_type_support_handle<topology_msgs::msg::MapProperty>();
}
