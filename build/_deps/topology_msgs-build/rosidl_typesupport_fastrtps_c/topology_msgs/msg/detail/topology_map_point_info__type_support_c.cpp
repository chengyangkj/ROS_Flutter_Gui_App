...
#include "topology_msgs/msg/detail/topology_map_point_info__rosidl_typesupport_fastrtps_c.h"
...
using _TopologyMapPointInfo__ros_msg_type = topology_msgs__msg__TopologyMapPointInfo;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _TopologyMapPointInfo__ros_msg_type * ros_message = static_cast<const _TopologyMapPointInfo__ros_msg_type *>(untyped_ros_message);
  // Field name: name
  {
  ...
  void * untyped_ros_message)
{
  ...
  _TopologyMapPointInfo__ros_msg_type * ros_message = static_cast<_TopologyMapPointInfo__ros_msg_type *>(untyped_ros_message);
  // Field name: name
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _TopologyMapPointInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_topology_msgs__msg__TopologyMapPointInfo(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = topology_msgs__msg__TopologyMapPointInfo;
    is_plain =
      (
...
static size_t _TopologyMapPointInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_topology_msgs__msg__TopologyMapPointInfo(
...
static message_type_support_callbacks_t __callbacks_TopologyMapPointInfo = {
  "topology_msgs::msg",
...
static rosidl_message_type_support_t _TopologyMapPointInfo__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_TopologyMapPointInfo,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, topology_msgs, msg, TopologyMapPointInfo)() {
  return &_TopologyMapPointInfo__type_support;
}
