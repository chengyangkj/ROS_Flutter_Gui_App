...
bool topology_msgs__msg__topology_map_point_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("topology_msgs.msg._topology_map_point_info.TopologyMapPointInfo", full_classname_dest, 63) == 0);
  }
  topology_msgs__msg__TopologyMapPointInfo * ros_message = _ros_message;
  {  // name
...
{
  /* NOTE(esteve): Call constructor of TopologyMapPointInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("topology_msgs.msg._topology_map_point_info");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TopologyMapPointInfo");
