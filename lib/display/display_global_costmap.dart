...
class DisplayGlobalCostMap extends StatefulWidget {
  final double opacity;

  const DisplayGlobalCostMap({
    super.key,
    this.opacity = 0.4,
  });

  @override
  _DisplayGlobalCostMapState createState() => _DisplayGlobalCostMapState();
}

class _DisplayGlobalCostMapState extends State<DisplayGlobalCostMap> {
    ...
    return RepaintBoundary(
      ...
      builder: (context, costMap, child) {
        ...
        return Container(
          ...
          child: CustomPaint(
          painter: DisplayGlobalCostMapPainter(
...
class DisplayGlobalCostMapPainter extends CustomPainter {
  final List<CostMapPoint> costMapPoints;

  DisplayGlobalCostMapPainter({
  ...
  @override
  bool shouldRepaint(covariant DisplayGlobalCostMapPainter oldDelegate) {
    return true;
  }
}
